...
* 目录索引
    * [一、KVM 原理](#一、KVM 原理)
    * [二、KVM 基础功能](#二、KVM 基础功能)
         * [2.1 CPU](#2.1 CPU)
         * [2.2 内存](#2.2 内存)
         * [2.3 存储](#2.3 存储)
         * [2.4 网络](#2.4 网络)
    * [KVM 高级功能](#三、KVM 高级功能)
         * [3.1 半虚拟化驱动](#3.1 半虚拟化驱动)
         * [3.2 热插拔 (hot plugging)](#3.2 热插拔 (hot plugging))
         * [3.3 动态迁移](#3.3 动态迁移)
    * [四、KVM 管理工具](#四、KVM 管理工具)
         * [libvirt](#libvirt)
    * [五、参考文档](#五、参考文档)
...
`qemu-img` 默认创建的格式是 `raw`，man手册中对几种格式也都有介绍。以下为对 raw 和 qcow2 镜像的详细介绍：
...
![qemu-emulated-io](images/qemu-emulated-io.jpg)
...
![qemu-kvm-virtio](images/qemu-kvm-virtio.jpg)
...
![libvirt_support](images/libvirt-support.png)
